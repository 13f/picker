...
namespace ConsoleDBApp.Models
{
    ...
    partial void DeleteSACQueryState(SACQueryState instance);
		...
		public SacDataContext() : 
				base(global::UpdateConsole.Properties.Settings.Default.sacConnectionString, mappingSource)
		{
			OnCreated();
		}
	...
	public partial class SACChinaStandard : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.DateTime _RevocatoryDate;
    ...
    partial void OnRevocatoryDateChanging(System.DateTime value);
    ...
    partial void OnProcessedAtChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_RevocatoryDate", DbType="Date NOT NULL", IsPrimaryKey=true)]
		public System.DateTime RevocatoryDate
		{
			get
			{
